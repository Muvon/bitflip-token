...
The BitFlip Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in BitFlip Core requires ZeroMQ API version 4.x or
...
using. BitFlipd appends an up-counting sequence number to each
