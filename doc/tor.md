...
The first step is running BitFlip behind a Tor proxy. This will already make all
...
BitFlip Core automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if BitFlip Core is listening (`-listen`), and
