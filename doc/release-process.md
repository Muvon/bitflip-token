...
### BitFlip maintainers/release engineers, update version in sources
...
### Build and sign BitFlip Core for Linux, Windows, and OS X:
...
space *do not upload these to the bitflip.info server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the bitflip.info server.

```

- Update bitflip.info version

- Announce the release:

  - litecoin-dev and litecoin-dev mailing list

  - blog.bitflip.info blog post

  - Update title of #litecoin and #litecoin-dev on Freenode IRC

  - Optionally twitter, reddit /r/BitFlip, ... but this will usually sort out itself
