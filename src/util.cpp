...
const char * const BITCOIN_CONF_FILENAME = "bitflip.conf";
const char * const BITCOIN_PID_FILENAME = "bitflip.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitFlip";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitFlip";
#else
    // Unix
    return pathRet / ".bitflip";
#endif
#endif
}
