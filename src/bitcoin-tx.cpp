...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitflip-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitflip-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitflip transaction") + "\n" +
              "  bitflip-tx [options] -create [commands]   " + _("Create hex-encoded bitflip transaction") + "\n" +
              "\n";
