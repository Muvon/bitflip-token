...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.bitflip.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("bitfliptools.com", "dnsseed.bitfliptools.com"));
        vSeeds.push_back(CDNSSeedData("bitflippool.org", "dnsseed.bitflippool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("bitfliptools.com", "testnet-seed.bitfliptools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.bitflip.loshan.co.uk", true));
